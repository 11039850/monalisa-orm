...
public class TestRecord extends com.tsc9526.monalisa.core.query.model.Model<TestRecord> implements test.com.tsc9526.monalisa.core.mysql.MysqlDB{
	private static final long serialVersionUID = 967431795707L;
...
@Column(table=M.TABLE, jdbcType=12, name=M.updateBy$name, key=M.updateBy$key, auto=M.updateBy$auto, notnull=M.updateBy$notnull, length=M.updateBy$length, value=M.updateBy$value, remarks=M.updateBy$remarks) 
	...
	public static class Insert extends com.tsc9526.monalisa.core.query.dao.Insert<TestRecord>{
		Insert(TestRecord model){
			super(model);
		}	 
	}	
	
	public static class Delete extends com.tsc9526.monalisa.core.query.dao.Delete<TestRecord>{
	...
	public static class Update extends com.tsc9526.monalisa.core.query.dao.Update<TestRecord>{
		Update(TestRecord model){
			super(model);
		}		 			 			 		
	}
	
	public static class Select extends com.tsc9526.monalisa.core.query.dao.Select<TestRecord,Select>{		
		Select(TestRecord x){
			super(x);
		}					 
	...
	public static class Example extends com.tsc9526.monalisa.core.query.criteria.Example<Criteria,TestRecord>{
		public Example(){}
		...
		protected Criteria createInternal(){
			...
			Class clazz=ClassHelper.findClassWithAnnotation(TestRecord.class,DB.class);	  			
...
@Column(table=M.TABLE, jdbcType=4, name=M.recordId$name, key=M.recordId$key, auto=M.recordId$auto, notnull=M.recordId$notnull, length=M.recordId$length, value=M.recordId$value, remarks=M.recordId$remarks)
		...
		public com.tsc9526.monalisa.core.query.criteria.Field.FieldInteger<Criteria> recordId = new com.tsc9526.monalisa.core.query.criteria.Field.FieldInteger<Criteria>("record_id", this);
