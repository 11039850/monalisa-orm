package test.com.tsc9526.monalisa.orm.dialect.postgres.postgresdb;
...
public class TestRecord extends com.tsc9526.monalisa.orm.model.Model<TestRecord> implements test.com.tsc9526.monalisa.orm.dialect.postgres.PostgresDB{
	...
	*/
	@Column(table=M.TABLE, jdbcType=4, name=M.version$name, key=M.version$key, auto=M.version$auto, seq=M.version$seq, notnull=M.version$notnull, length=M.version$length, decimalDigits=M.version$decimalDigits, value=M.version$value, remarks=M.version$remarks) 
	public TestRecord setVersion(Integer version){
	...
	*/
	...
	public static class $Select extends com.tsc9526.monalisa.orm.dao.Select<TestRecord,$Select>{		
		...
		* @param recordId 自增主键	
		*/
		public TestRecord selectByRecordId(Integer recordId){	
			$Criteria c=WHERE();
		...
		*/
		public Map<Integer,TestRecord> selectToMapWithRecordId(String whereStatement,Object ... args){
		...
		*/
		public Map<Integer,TestRecord> selectByExampleToMapWithRecordId($Example example){
		...
		*/
		...
		public class $SelectForExample extends com.tsc9526.monalisa.orm.dao.Select<TestRecord,$Select>.$SelectForExample{
			...
			* List result to Map, The map key is unique-key: recordId 
			*/
			public Map<Integer,TestRecord> selectToMapWithRecordId(){
