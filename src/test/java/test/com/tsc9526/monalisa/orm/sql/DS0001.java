...
public class DS0001 implements java.io.Serializable{
	...
	*/
	@Column(table=TestTable1.M.TABLE, jdbcType=4, name=TestTable1.M.id$name, key=TestTable1.M.id$key, auto=TestTable1.M.id$auto, seq=TestTable1.M.id$seq, notnull=TestTable1.M.id$notnull, length=TestTable1.M.id$length, value=TestTable1.M.id$value, remarks=TestTable1.M.id$remarks)
	private Integer id;	
	...
	*/
	@Column(table=TestTable1.M.TABLE, jdbcType=12, name=TestTable1.M.name$name, key=TestTable1.M.name$key, auto=TestTable1.M.name$auto, seq=TestTable1.M.name$seq, notnull=TestTable1.M.name$notnull, length=TestTable1.M.name$length, value=TestTable1.M.name$value, remarks=TestTable1.M.name$remarks)
	private String name;	
	...
	*/
	@Column(table=TestTable1.M.TABLE, jdbcType=12, name=TestTable1.M.title$name, key=TestTable1.M.title$key, auto=TestTable1.M.title$auto, seq=TestTable1.M.title$seq, notnull=TestTable1.M.title$notnull, length=TestTable1.M.title$length, value=TestTable1.M.title$value, remarks=TestTable1.M.title$remarks)
	...
	* <li><B>remarks:</B> 
	*/
	@Column(table=TestTable1.M.TABLE, jdbcType=93, name=TestTable1.M.tsA$name, key=TestTable1.M.tsA$key, auto=TestTable1.M.tsA$auto, seq=TestTable1.M.tsA$seq, notnull=TestTable1.M.tsA$notnull, length=TestTable1.M.tsA$length, value=TestTable1.M.tsA$value, remarks=TestTable1.M.tsA$remarks)
	...
	* <li><B>remarks:</B> primary key
	*/
	@Column(table=TestTable2.M.TABLE, jdbcType=4, name=TestTable2.M.id$name, key=TestTable2.M.id$key, auto=TestTable2.M.id$auto, seq=TestTable2.M.id$seq, notnull=TestTable2.M.id$notnull, length=TestTable2.M.id$length, value=TestTable2.M.id$value, remarks=TestTable2.M.id$remarks)
	private Integer id1;	
	...
	* <li><B>remarks:</B> the name
	*/
	@Column(table=TestTable2.M.TABLE, jdbcType=12, name=TestTable2.M.name$name, key=TestTable2.M.name$key, auto=TestTable2.M.name$auto, seq=TestTable2.M.name$seq, notnull=TestTable2.M.name$notnull, length=TestTable2.M.name$length, value=TestTable2.M.name$value, remarks=TestTable2.M.name$remarks)
	...
	* <li><B>remarks:</B> the title
	*/
	@Column(table=TestTable2.M.TABLE, jdbcType=12, name=TestTable2.M.title$name, key=TestTable2.M.title$key, auto=TestTable2.M.title$auto, seq=TestTable2.M.title$seq, notnull=TestTable2.M.title$notnull, length=TestTable2.M.title$length, value=TestTable2.M.title$value, remarks=TestTable2.M.title$remarks)
	...
	*/
	@Column(table=TestTable2.M.TABLE, jdbcType=12, name=TestTable2.M.arrayInt$name, key=TestTable2.M.arrayInt$key, auto=TestTable2.M.arrayInt$auto, seq=TestTable2.M.arrayInt$seq, notnull=TestTable2.M.arrayInt$notnull, length=TestTable2.M.arrayInt$length, value=TestTable2.M.arrayInt$value, remarks=TestTable2.M.arrayInt$remarks)
	...
	*/
	@Column(table=TestTable2.M.TABLE, jdbcType=12, name=TestTable2.M.json$name, key=TestTable2.M.json$key, auto=TestTable2.M.json$auto, seq=TestTable2.M.json$seq, notnull=TestTable2.M.json$notnull, length=TestTable2.M.json$length, value=TestTable2.M.json$value, remarks=TestTable2.M.json$remarks)
	...
	*/
	@Column(table=TestTable2.M.TABLE, jdbcType=12, name=TestTable2.M.obj$name, key=TestTable2.M.obj$key, auto=TestTable2.M.obj$auto, seq=TestTable2.M.obj$seq, notnull=TestTable2.M.obj$notnull, length=TestTable2.M.obj$length, value=TestTable2.M.obj$value, remarks=TestTable2.M.obj$remarks)
	...
	* <li><B>remarks:</B> 
	*/
	@Column(table=TestTable2.M.TABLE, jdbcType=93, name=TestTable2.M.tsA$name, key=TestTable2.M.tsA$key, auto=TestTable2.M.tsA$auto, seq=TestTable2.M.tsA$seq, notnull=TestTable2.M.tsA$notnull, length=TestTable2.M.tsA$length, value=TestTable2.M.tsA$value, remarks=TestTable2.M.tsA$remarks)
	...
	* <li><B>remarks:</B> 
	*/
	@Column(table=TestTable2.M.TABLE, jdbcType=93, name=TestTable2.M.createTime$name, key=TestTable2.M.createTime$key, auto=TestTable2.M.createTime$auto, seq=TestTable2.M.createTime$seq, notnull=TestTable2.M.createTime$notnull, length=TestTable2.M.createTime$length, value=TestTable2.M.createTime$value, remarks=TestTable2.M.createTime$remarks)
	...
	* <li><B>remarks:</B> version
	*/
	@Column(table=TestTable2.M.TABLE, jdbcType=4, name=TestTable2.M.v1$name, key=TestTable2.M.v1$key, auto=TestTable2.M.v1$auto, seq=TestTable2.M.v1$seq, notnull=TestTable2.M.v1$notnull, length=TestTable2.M.v1$length, value=TestTable2.M.v1$value, remarks=TestTable2.M.v1$remarks)
	private Integer v1;	
