 ...
 *******************************************************************************************/
package test.com.tsc9526.monalisa.orm.jsp;
...
public class JspParserTest {
	...
	public void testJspPageAttribute(){
		...
		page.parseCode("import = \r\n \"test.com.tsc9526.monalisa.orm.mysql.MysqlDB,\r\n com.tsc9526.monalisa.orm.Query\"");	
		Assert.assertEquals(page.getImports().size(),2);
		Assert.assertTrue(page.getImports().contains("test.com.tsc9526.monalisa.orm.mysql.MysqlDB"));
		Assert.assertTrue(page.getImports().contains("com.tsc9526.monalisa.orm.Query"));
	}
}
