...
public class TestTable2 extends com.tsc9526.monalisa.orm.model.Model<TestTable2> implements test.com.tsc9526.monalisa.orm.dialect.mysql.MysqlDB{
	...
	*/
	@Column(table=M.TABLE, jdbcType=12, name=M.arrayInt$name, key=M.arrayInt$key, auto=M.arrayInt$auto, seq=M.arrayInt$seq, notnull=M.arrayInt$notnull, length=M.arrayInt$length, value=M.arrayInt$value, remarks=M.arrayInt$remarks)
	@Alias("array_int")
	...
	*/
	@Column(table=M.TABLE, jdbcType=12, name=M.arrayString$name, key=M.arrayString$key, auto=M.arrayString$auto, seq=M.arrayString$seq, notnull=M.arrayString$notnull, length=M.arrayString$length, value=M.arrayString$value, remarks=M.arrayString$remarks)
	@Alias("array_string")
	...
	*/
	@Column(table=M.TABLE, jdbcType=12, name=M.json$name, key=M.json$key, auto=M.json$auto, seq=M.json$seq, notnull=M.json$notnull, length=M.json$length, value=M.json$value, remarks=M.json$remarks)
	...
	*/
	@Column(table=M.TABLE, jdbcType=12, name=M.obj$name, key=M.obj$key, auto=M.obj$auto, seq=M.obj$seq, notnull=M.obj$notnull, length=M.obj$length, value=M.obj$value, remarks=M.obj$remarks)
	...
	*/
	@Column(table=M.TABLE, jdbcType=4, name=M.v1$name, key=M.v1$key, auto=M.v1$auto, seq=M.v1$seq, notnull=M.v1$notnull, length=M.v1$length, value=M.v1$value, remarks=M.v1$remarks)
	private Integer v1;	
