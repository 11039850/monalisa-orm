...
public class TestTable2 extends com.tsc9526.monalisa.orm.model.Model<TestTable2> implements test.com.tsc9526.monalisa.orm.dialect.mysql.MysqlDB{
	private static final long serialVersionUID = 1512417379200L;
	...
	*/
	@Column(table=M.TABLE, jdbcType=12, name=M.arrayInt$name, key=M.arrayInt$key, auto=M.arrayInt$auto, seq=M.arrayInt$seq, notnull=M.arrayInt$notnull, length=M.arrayInt$length, decimalDigits=M.arrayInt$decimalDigits, value=M.arrayInt$value, remarks=M.arrayInt$remarks)
	@Alias("array_int")
	...
	*/
	@Column(table=M.TABLE, jdbcType=12, name=M.arrayString$name, key=M.arrayString$key, auto=M.arrayString$auto, seq=M.arrayString$seq, notnull=M.arrayString$notnull, length=M.arrayString$length, decimalDigits=M.arrayString$decimalDigits, value=M.arrayString$value, remarks=M.arrayString$remarks)
	@Alias("array_string")
	...
	*/
	@Column(table=M.TABLE, jdbcType=12, name=M.json$name, key=M.json$key, auto=M.json$auto, seq=M.json$seq, notnull=M.json$notnull, length=M.json$length, decimalDigits=M.json$decimalDigits, value=M.json$value, remarks=M.json$remarks)
	...
	*/
	@Column(table=M.TABLE, jdbcType=12, name=M.obj$name, key=M.obj$key, auto=M.obj$auto, seq=M.obj$seq, notnull=M.obj$notnull, length=M.obj$length, decimalDigits=M.obj$decimalDigits, value=M.obj$value, remarks=M.obj$remarks)
	...
	*/
	@Column(table=M.TABLE, jdbcType=4, name=M.v1$name, key=M.v1$key, auto=M.v1$auto, seq=M.v1$seq, notnull=M.v1$notnull, length=M.v1$length, decimalDigits=M.v1$decimalDigits, value=M.v1$value, remarks=M.v1$remarks)
	private Integer v1;	
	...
	*/
	@Column(table=M.TABLE, jdbcType=4, name=M.v1$name, key=M.v1$key, auto=M.v1$auto, seq=M.v1$seq, notnull=M.v1$notnull, length=M.v1$length, decimalDigits=M.v1$decimalDigits, value=M.v1$value, remarks=M.v1$remarks) 
	public Integer getV1AsInt(Integer defaultValue){
		Number r = getV1();
		if(r!=null){
			return r.intValue();
		}else{
	...
	*/ 
	public static class M{
		...
		public final static int     arrayInt$decimalDigits = 0;
		public final static String  arrayInt$value         = "NULL";
		public final static String  arrayInt$remarks       = "array of int. #array{int}";
		public final static boolean arrayInt$auto          = false;
		public final static boolean arrayInt$notnull       = false;
		public final static String  arrayInt$seq           = "";
		...
		public final static int     arrayString$decimalDigits = 0;
		public final static String  arrayString$value         = "NULL";
		public final static String  arrayString$remarks       = "array of string. #array{}";
		public final static boolean arrayString$auto          = false;
		public final static boolean arrayString$notnull       = false;
		public final static String  arrayString$seq           = "";
		...
		public final static int     v1$decimalDigits = 0;
		...
		public final static String  v1$seq           = "";
