...
public class DBWriterHelper {
	...
	public void createDBModelWriter()throws Exception{
		...
		writeToJava(jsp,new JavaWriter(fos), "com.tsc9526.monalisa.core.generator", "DBWriterModel");
	...
	public void createDBSelectWriter()throws Exception{
		...
		writeToJava(jsp,new JavaWriter(fos), "com.tsc9526.monalisa.core.generator", "DBWriterSelect");
