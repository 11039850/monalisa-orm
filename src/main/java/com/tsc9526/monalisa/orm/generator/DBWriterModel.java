...
public class DBWriterModel{
	...
	if(annotation!=null){ 
		...
		if(set!=null){ 
			...
			out.println("	");
			out.print("	");
			if(f.getJavaType().equals("java.math.BigDecimal") ){		out.println("");
			out.print("	");
			out.print(getComments(table,f,"	","\t"));
			out.println(" ");
			out.print("	public ");
			...
			out.print("(");
			out.print(f.getJavaName());
			out.print(" ==null? (java.math.BigDecimal)null : new java.math.BigDecimal(");
			out.print(f.getJavaName());
			out.println("));");
			out.println("	}");
			out.println("	");
			...
			out.print("(");
			out.print(f.getJavaName());
			out.print(" ==null? (Long)null: new Long(");
			out.print(f.getJavaName());
			out.println("));");
			out.println("	}");
			out.print("	");
		...
		if(get!=null){ 
			...
			out.print("		java.math.BigDecimal r = ");
			out.print(f.getJavaNameGet());
			out.println("();");
			out.println("		if(r!=null){");
			out.println("			return r.intValue();");
			out.println("		}else{");
			...
			out.print(f.getJavaNameGet());
			out.println("AsLong(Long defaultValue){");
			out.print("		java.math.BigDecimal r = ");
			out.print(f.getJavaNameGet());
			out.println("();");
			out.println("		if(r!=null){");
			out.println("			return r.longValue();");
			out.println("		}else{");
			out.println("			return defaultValue;");
			out.println("		}");
			out.println("	}");
		...
		if(table.getKeyColumns().size()==1){
			...
			out.println("\", this);");
			out.print("		");
			}else if(f.getJavaType().equals("java.math.BigDecimal")){ 		out.print("public com.tsc9526.monalisa.orm.criteria.Field.FieldBigDecimal<$Criteria> ");
			out.print(f.getJavaName());
			out.print(" = new com.tsc9526.monalisa.orm.criteria.Field.FieldBigDecimal<$Criteria>(\"");
			out.print(f.getName());
			out.println("\", this);");
			out.print("		");
