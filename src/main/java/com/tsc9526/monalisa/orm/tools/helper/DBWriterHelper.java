...
import com.tsc9526.monalisa.orm.parser.jsp.Jsp;
import com.tsc9526.monalisa.orm.parser.jsp.JspCode;
import com.tsc9526.monalisa.orm.parser.jsp.JspContext;
import com.tsc9526.monalisa.orm.parser.jsp.JspElement;
import com.tsc9526.monalisa.orm.parser.jsp.JspEval;
import com.tsc9526.monalisa.orm.parser.jsp.JspFunction;
import com.tsc9526.monalisa.orm.parser.jsp.JspPage;
import com.tsc9526.monalisa.orm.parser.jsp.JspText;
...
public class DBWriterHelper {
	...
	public void createDBModelWriter()throws Exception{
		File jspFile=new File("./src/main/resources/com/tsc9526/monalisa/orm/tools/resources/template/model.jsp");
		Jsp jsp=new Jsp(jspFile);
		
		FileOutputStream fos=new FileOutputStream("src/main/java/com/tsc9526/monalisa/orm/tools/generator/DBWriterModel.java");
		writeToJava(jsp,new JavaWriter(fos), "com.tsc9526.monalisa.orm.tools.generator", "DBWriterModel");
		
	}
	
	public void createDBSelectWriter()throws Exception{
		File jspFile=new File("./src/main/resources/com/tsc9526/monalisa/orm/tools/resources/template/select.jsp");
		Jsp jsp=new Jsp(jspFile);
		
		FileOutputStream fos=new FileOutputStream("src/main/java/com/tsc9526/monalisa/orm/tools/generator/DBWriterSelect.java");
		writeToJava(jsp,new JavaWriter(fos), "com.tsc9526.monalisa.orm.tools.generator", "DBWriterSelect");
	...
	public void writeToJava(Jsp jsp,PrintWriter w,String packageName,String javaName)throws IOException{
		...
		w.println("/**  @author zzg.zhou(11039850@qq.com)  */");
