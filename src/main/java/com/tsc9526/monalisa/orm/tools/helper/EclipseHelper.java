...
public class EclipseHelper {
	static Logger logger=Logger.getLogger(EclipseHelper.class);
	...
	public static String findCfgBasePathByClass(Class<?> clazz){
		...
		if(ewd!=null){
			...
			File f=ClassPathHelper.getClassOrJarFile(clazz);
	...
	public static String getProjectLocation(String eclipseWorkspaceDir, String projectName) {
		...
		String lf=FileHelper.combinePath(eclipseWorkspaceDir,basePath,projectName,".location");
